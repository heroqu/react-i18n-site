/**
 * Here we can specify which exact type faces and their variants
 * we'd like to use in our app. We should only point to variants
 * that are actually being used, thus making the app bundle lighter.
 */
